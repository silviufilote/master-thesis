...
classdef stem_EM_options
    ...
    properties
        ...
        fminsearch_max_iterations=200;              %[integer >0] (1x1) the fminsearch method used for updating model parameters stops if the number of iterations exceed fminsearch_max_iterations
