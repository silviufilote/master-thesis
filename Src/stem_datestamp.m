            ...
            if (nargin==1)
                ...
                elseif ischar(date_start)
                    try
                        ...
                        obj.date_start=datetime(date_start,'InputFormat','dd-MM-yyyy HH:mm:ss');
                    end
                ...
                elseif ischar(date_end)
                    try
                        ...
                        obj.date_end=datetime(date_end,'InputFormat','dd-MM-yyyy HH:mm:ss');
                    end
                elseif isstring(date_end)
                    ...
                    error('Please format the date as dd-MM-yyyy HH:mm or dd-MM-yyyy HH:mm:ss')
                end
