...
% model definition
obj_stem_validation = stem_validation({'INGV PGA', 'EQN PSA'}, {S_val_sta, S_val_sma}, 0, {'point','point'});
...
% --- Epicenter ---
geoscatter(event_info.latitude, event_info.longitude, 400, 'p', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', [0.3 0.0 0.4], 'LineWidth', 2);
